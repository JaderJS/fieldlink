...
var ssr_exports = /* @__PURE__ */ __exportAll({
	TSS_SERVER_FUNCTION: () => TSS_SERVER_FUNCTION,
	createServerEntry: () => createServerEntry,
	createServerFn: () => createServerFn,
	default: () => server_default,
	getRequestHeaders: () => getRequestHeaders,
	getServerFnById: () => getServerFnById
});
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BhzCB3Yf.mjs");
...
var manifest = {
	"36bec7d5499ec438c211301120fba630bf92287265062e29295366407a9815be": {
		functionName: "upsertCustomer_createServerFn_handler",
		importer: () => import("./api-DllcyTS1.mjs")
	},
	"377a79c83ebee1c882603c04c55513dc8dc4187df5afd49c2045d82412f61386": {
		functionName: "getStations_createServerFn_handler",
		importer: () => import("./api-DekneBQT.mjs")
	},
	"71290b1b7391db43eedcf4f12dc9dc674879c2e57ad3d8d794eb86553bcc4fec": {
		functionName: "deleteCustomer_createServerFn_handler",
		importer: () => import("./api-DllcyTS1.mjs")
	},
	"c2d7642ddf03a7d487900639a32dc0ce3c948b4ae3a383fb6dadb00a67db776c": {
		functionName: "getCustomers_createServerFn_handler",
		importer: () => import("./api-DllcyTS1.mjs")
	},
	"cd33664f22a3f6072d75575f18b2abf93262d944511d91e5808350642e110e21": {
		functionName: "getServerSession_createServerFn_handler",
		importer: () => import("./functions-Duahul-a.mjs")
	},
	"eaed7870e51636405d7a4bb8b2ea19ba857d845d137abaed0eca71fbbe7dad9b": {
		functionName: "createStation_createServerFn_handler",
		importer: () => import("./api-DekneBQT.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B1dUlNHz.mjs").then((n) => n.router_exports),
		import("./start-DvpqNK8x.mjs"),
		import("./empty-plugin-adapters-CobwWRUA.mjs")
	]);
	return {
		routerEntry,
		startEntry,
...
//#endregion
export { TSS_SERVER_FUNCTION, createServerEntry, createServerFn, server_default as default, getRequestHeaders, getServerFnById, ssr_exports };
